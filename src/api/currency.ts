...
router.get(
  ...
  async (
    ...
    */
    ...
    try {
      const rs = await axios.get(`https://www.koreaexim.go.kr/site/program/financial/exchangeJSON?authkey=kafcch9C4fr3kjWiRMGlWzDOblqWqtln&searchdate=${dt8}&data=AP01`)
